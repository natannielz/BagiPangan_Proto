        ...
        <div class="p-6 text-gray-900 space-y-4">
            ...
            <div class="space-y-3">
                @forelse ($notifications as $notification)
                    ...
                    <div class="border border-gray-100 rounded-2xl p-4 flex items-start justify-between gap-4">
                        <div class="space-y-1">
                            <div class="flex items-center gap-2">
                                <div class="font-semibold text-gray-900">{{ $message }}</div>
                                @if (is_null($notification->read_at))
                                    <span class="text-xs px-2 py-1 rounded-full bg-yellow-50 text-yellow-800">baru</span>
                                @endif
                            </div>
                            @if ($title)
